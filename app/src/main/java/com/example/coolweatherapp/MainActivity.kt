...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        updateButton.setOnClickListener {
            ...
            val latitude = findViewById<TextView>(R.id.latitudeValue).text.toString().toFloat()

            val longitude = findViewById<TextView>(R.id.longitudeValue).text.toString().toFloat()
    ...
    private fun updateUI (request : WeatherData ){
        runOnUiThread {
            ...
            val direction : TextView = findViewById(R.id.winddirectionValue)
            val speed : TextView = findViewById(R.id.windspeedValue)
            val temp_value : TextView = findViewById(R.id.temperatureValue)
